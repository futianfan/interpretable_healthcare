...
python2 ./src/prototype_rule_plus_random_alignment.py results/rule_data_list ./data/train_lstm_output.npy ./data/training_label  ./data/test_lstm_output.npy ./data/test_label  ./results/similarity
...
class RLP(torch.nn.Module):
    ...
    def generate_prototype(self, data_dict, rule_dict):  
        ...
        for i in range(PROTOTYPE_NUM):
            self.prototype[i,:] = (self.prototype[i,:] + factor * Variable(p_average)) / (1 + factor)
